...
class MySQLConfigWidget(_DBConfigWidget):
    def __init__(self, parent=None):
        super(MySQLConfigWidget, self).__init__(parent)

        self.setWindowTitle("MySQL 连接配置")
    ...
    def _init_ui(self):
        ...
        # icon
        icon = QIcon("../assets/icons/widget/MySQL.png")
